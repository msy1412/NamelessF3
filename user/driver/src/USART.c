...
{
	Quad_DMA_Config(DMA1_Channel4,(u32)&USART1->RDR,(u32)SendBuff,len);//DMA1通道4,外设为串口1,存储器为SendBuff,长度len.
...
{
	Quad_DMA1_Config(DMA1_Channel2,(u32)&USART3->RDR,(u32)SendBuff,len);//DMA1通道4,外设为串口1,存储器为SendBuff,长度len.
